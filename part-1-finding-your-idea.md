...
For a further learning about other types of review, do check out this paper by Munn, Z. et al. on _**What kind of systematic review should I conduct? A proposed typology and guidance for systematic reviewers in the medical and health sciences.**_ BMC Med Res Methodol 18, 5 (2018). [https://doi.org/10.1186/s12874-017-0468-4](https://doi.org/10.1186/s12874-017-0468-4).
...
* **The Research Question** is the **"inquisitive" side**. It is what you want to _know_. It is always phrased as a question (e.g., "What is the prevalence of...?").
* **The Research Objectives** are the **"active" side**. They are what you will _do_ to find the answer. They are always phrased as a statement of intent, using strong action verbs (e.g., "To determine the prevalence of...").
